...
public class GuiElevatorRadialButton extends GuiButton {
    ...
    public void drawButton(Minecraft minecraft, int i, int j) {
        ...
        fontrenderer.drawString(displayString, xPosition + 13 + 1, yPosition + height/2 - 4, color);
    }
    ...
    public boolean mousePressed(Minecraft minecraft, int i, int j) {
    	...
    	//mod_ExpandedArt.say((new StringBuilder()).append(i).append(", ").append(j).toString());
    	//mod_ExpandedArt.say((new StringBuilder()).append(xPosition).append(", ").append(yPosition).append(": ").append(width).append(", ").append(height).toString());
